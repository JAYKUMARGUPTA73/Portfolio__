...
const Hero = () => {
  ...
  return (
    <section id="hero" className="min-h-screen bg-[#0a192f] flex items-center justify-center relative overflow-hidden p-4 md:p-0">
      <div className="text-center z-10">
        ...
        >
          <div className='mx-32 pl-28 mb-6  md:ml-32'>
            <FractalTree/>
          </div>
          {showTypingEffect && (
            <TypingEffect text="hi, gazi here. |" />
          )}
        </motion.h1>
        <motion.p
...
const TypingEffect = ({ text }) => {
  ...
  return <span dangerouslySetInnerHTML={highlightWord(displayText, 'gazi')} />;
};
